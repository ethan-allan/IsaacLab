...
from omni.isaac.lab.assets import  AssetBaseCfg, RigidObjectCfg, RigidObject   # Provides base asset configuration class  (generic structure for storing assets)       
...
class FrankaTestSceneCfg(InteractiveSceneCfg):
    ...
    peg = RigidObjectCfg(
            ...
            spawn=sim_utils.UsdFileCfg(
                usd_path=f"/home/ethanallan175/IsaacLab/source/extensions/omni.isaac.lab_tasks/omni/isaac/lab_tasks/manager_based/custom/screw_removal/peg.usd",
                scale=(1.0 , 1.0, 1.0),
